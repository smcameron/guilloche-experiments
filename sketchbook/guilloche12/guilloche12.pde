...
void draw()
{
  ...
  for (int i = 0; i < 1000; i++) {
    ...
    r1 = (sin(t * 10 * 10) / 2.0) + 0.5;
    x4 = x3 * r1 * (current_outer_rad - current_inner_rad) + innerx;
    y4 = y3 * r1 * (current_outer_rad - current_inner_rad) + innery;

    r2 = (sin(t * 10 * 10 + PI / 2) / 2.0) + 0.5;
    x5 = x3 * r2 * (current_outer_rad - current_inner_rad) + innerx;
    y5 = y3 * r2 * (current_outer_rad - current_inner_rad) + innery;
